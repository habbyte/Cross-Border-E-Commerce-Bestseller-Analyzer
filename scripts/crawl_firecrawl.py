...
from app.scrapers import FirecrawlScraper
...
def main():
    ...
    filepath = scraper.save_results(result_data, "firecrawl_products.json")
    ...
    if products:
        ...
        affected = bulk_upsert_products_with_categories(data, actor_user_id=None, run_id="run-firecrawl")
        print(f"Upsert {affected} products to PostgreSQL")
        
        # 寫入 MongoDB
        mongo_affected = bulk_upsert_products_mongodb(data, run_id="run-firecrawl")
