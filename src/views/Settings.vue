      ...
      <div class="settings-section">
        ...
        <div class="settings-grid">
          <div class="setting-item">
            ...
            <select v-model="settingsStore.settings.search.defaultPlatform" class="form-select">
          ...
          <div class="setting-item">
            ...
            <select v-model="settingsStore.settings.search.pageSize" class="form-select">
          ...
          <div class="setting-item">
            ...
            <div class="toggle-switch">
              <input 
                type="checkbox" 
                id="autoRefresh" 
                v-model="settingsStore.settings.search.autoRefresh"
              />
